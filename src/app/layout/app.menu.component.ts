        ...
        this.model = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Button', icon: 'pi pi-fw pi-box', routerLink: ['/admin/admin/uikit/button'] },
                    ...
                    { label: 'Menu', icon: 'pi pi-fw pi-bars', routerLink: ['/admin/uikit/menu'], routerLinkActiveOptions: { paths: 'subset', queryParams: 'ignored', matrixParams: 'ignored', fragment: 'ignored' } },
